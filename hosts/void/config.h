 ...
 * ------------------------------------------------------------ */
#define WS_BG              0x0f1219ff   /* desktop root color — wallpaper navy-shadow tone */
#define WS_BORDER          0x0f1219ff   /* unfocused window border — = root bg so inactive borders blend away */
#define WS_FOCUS           0x5f8a93ff   /* focused window border + accents — wallpaper misty blue-teal */
 ...
 * ------------------------------------------------------------ */
#define WS_WALLPAPER       "assets/012_pixelart.png"

/* ------------------------------------------------------------
 * COMPOSITOR — window manager behaviour
 * ------------------------------------------------------------ */
#define WS_SLOPPY_FOCUS    1       /* 1 = focus follows mouse */
#define WS_BORDER_PX       0       /* window border thickness (pixels) — 0 = no border */
#define WS_BORDER_RADIUS   10      /* window corner radius (px, 0 = square) */
#define WS_UNFOCUS_OPACITY 0.9f    /* opacity of unfocused windows (1.0 = none); focus cue with borderless windows */
...
#define WS_TRACKPAD_DISABLE_TYPING 0    /* 1 = disable pad while typing */
